...
class Model(nn.Module):  # ch=3-->ch=8
    def __init__(self, cfg='yolor-csp-x.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC,CSPStage]:
            ...
            if m in [DownC, SPPCSPC, GhostSPPCSPC,
                     ...
                     ST2CSPA, ST2CSPB, ST2CSPC,CSPStage]:
...
if __name__ == '__main__':
    ...
    if opt.profile:
        img = torch.rand(1, 8, 640, 640).to(device)
